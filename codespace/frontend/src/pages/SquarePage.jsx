    ...
    return (
        <div className="container square-page">
            ...
            {showProfileModal && selectedProfile && (
                <div className="modal-overlay" onClick={() => setShowProfileModal(false)} style={{
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    width: '100%',
                    ...
                    <div className="profile-modal card" onClick={(e) => e.stopPropagation()} style={{
                        ...
                        <h2>{selectedProfile.display_name || 'User'}</h2>
                        {selectedProfile.bio && <p style={{ color: '#666', marginBottom: '15px' }}>{selectedProfile.bio}</p>}
